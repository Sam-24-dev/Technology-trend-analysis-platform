...
_.cy=!0
_.db=!1
_.dx=$},akN:function akN(d){this.a=d},Px:function Px(d,e,f,g){var _=this
_.e=d
_.f=e
_.c=f
_.a=g},
...
if(u==null)u=C.U
x=J.d8(u,y.f)
x=B.cC(x,new A.aq3(),x.$ti.h("p.E"),y.U)
w=B.x(x,B.l(x).h("p.E"))
x=d.i(0,"dataset")
if(x!=null)J.T(x)
...
A.aN7(d.i(0,"sources_present"))
r=y.Y
q=A.aM_(r.a(d.i(0,"github_summary")),"GitHub","github")
p=A.aM_(r.a(d.i(0,"stackoverflow_summary")),"StackOverflow","stackoverflow")
o=A.aM_(r.a(d.i(0,"reddit_summary")),"Reddit","reddit")
n=J.d8(m,y.f)
n=B.cC(n,new A.aq2(),n.$ti.h("p.E"),y.H)
n=B.x(n,B.l(n).h("p.E"))
...
w=v.i(0,"label")
w=w==null?t:J.T(w)
w=new A.aq1(w==null?"":w)}u=x.a(d.i(0,"coverage"))
...
aN7(d){var x
if(y.j.b(d)){x=J.dF(d,new A.aI0(),y.N)
x=B.x(x,x.$ti.h("X.E"))
...
aMb(d,e){return new B.d4(d,B.F(d).h("d4<1>")).gdF().e6(0,new A.arq(e),y.D).bY(0)},
...
aST(d){var x=B.jC(d==null?"":d)
if(x==null)return""
return C.b.eG(C.e.k(B.q3(x)),2,"0")+"/"+C.b.eG(C.e.k(B.kM(x)),2,"0")+"/"+B.hB(x)},
b6u(d,e){if(d.length===0||e.length===0)return""
return"Comparado (UTC): "+d+" -> "+e},
b6y(d){var x=B.jC(d)
if(x==null)return d
return C.b.eG(C.e.k(B.q3(x)),2,"0")+"/"+C.b.eG(C.e.k(B.kM(x)),2,"0")},
...
x=e.length!==0?" "+e:""
return A.arQ(d)+x+" vs corrida previa"},
...
try{x=C.a2.fS(C.MG.c8(d))
return x}catch(w){return d}},
aMe(d){var x,w,v=C.b.au(A.aSU(d))
...
aMd(d){return new B.d4(d,B.F(d).h("d4<1>")).gdF().e6(0,new A.arx(),y.D).bY(0)},
...
if(C.b.l(v,"-"))return new B.dP(new B.a3(B.b(v.split("-"),y.s),new A.arO(),y.A),new A.arP(),y.X).b2(0," ")
...
w=new B.a3(w,new A.ary(a4),B.F(w).h("a3<1>")).dd(0,0,new A.arz())
x=w}if(x==null)x=0
v=b0?a3:C.c.dd(a5.a,0,new A.arA())
if(v==null)v=0
u=x>0?x:v
t=(b0?a3:a5.a.length!==0)===!0?C.c.gR(a5.a).a:"-"
s=b0?a3:C.c.dd(a5.c,0,new A.arF())
if(s==null)s=0
b0=a6==null
if(b0)r=a3
else{w=a6.a
w=new B.a3(w,new A.arG(a4),B.F(w).h("a3<1>")).dd(0,0,new A.arH())
r=w}if(r==null)r=0
q=b0?a3:C.c.dd(a6.a,0,new A.arI())
if(q==null)q=0
p=r>0?r:q
if(!b0&&a6.b.length!==0){w=a6.b
o=new B.y(w,new A.arJ(),B.F(w).h("y<1,m>")).c6(0,new A.arK())/w.length}else o=0
...
g=new B.y(a7,new A.arL(),B.F(a7).h("y<1,m>")).c6(0,new A.arM())/a7.length}else g=0
...
w=B.F(b0)
l=w.h("dP<1,m>")
l=B.kr(new B.dP(new B.a3(b0,new A.arB(a4),w.h("a3<1>")),new A.arC(),l),l.h("p.E"),y.y).vK(0,new A.arD(),new A.arE())
...
return new A.aFr(u,a0,t,l,p,w,b0+"%",a7,a2,C.d.K(g,0)+"%",f,e,m,A.aMc(d[0]),A.aMc(d[1]),A.aMc(d[2]),a1)},
b6A(d,e,f){var x=y.n,w=C.c.c6(B.b([d,e,f,1],x),new A.arR())
return B.b([d/w*100,e/w*100,f/w*100],x)},
aMc(d){var x=y.w
x=B.x(new B.y(B.b([0.36,0.48,0.61,0.74,0.86,1],y.n),new A.arv(d),x),x.h("X.E"))
return x},
...
this.b=e},
aFr:function aFr(d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t){var _=this
_.a=d
_.b=e
_.c=f
_.d=g
...
u=t.ch.a
return d.rJ(s,e,w,v,u instanceof B.kW?u:null)}else t.hh(d,e.S(0,x))
return null},
...
if(x)return!1
w.HA()
return d.uR(new A.akN(w),e,w.a4)},
...
A.v5.prototype={
oq(a3,a4){var x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i=null,h=a4.cF($.aJQ(),y.L),g=a4.cF($.aJU(),y.B),f=a4.cF($.aJT(),y.r),e=a4.cF($.aJV(),y.W),d=a4.cF($.AP(),y.G),a0=a4.cF($.aZM(),y.Z),a1=B.fT(h,y.a),a2=a1==null?i:a1.a
a1=B.fT(g,y.x)
x=a1==null?i:a1.a
a1=B.fT(f,y.u)
w=a1==null?i:a1.a
...
return B.eh(new A.arS(this,o,p,s,m,l,t))},
Pn(d,e){var x=null,w=B.aG(999),v=e.as,u=v==null,t=u?x:v.Am(C.ao)
t=B.aSz(D.LX,D.a1Q,new A.arg(d),B.aqa(x,x,C.pT,x,x,x,x,x,x,C.fn,x,C.S,C.KR,x,new B.cV(w,D.EF),x,x,C.mV,t,x))
return B.bU(C.F,B.b([t,B.Z("> An\xe1lisis por tecnolog\xeda",x,x,x,x,u?x:v.fR(C.aj,C.ao),x,x)],y.p),C.di,8,8)},
Ei(d,e){return B.eh(new A.arw(e,d))},
...
u=C.c.dd(n,0,new A.arj(x,w,v))
t=u<=0?100:Math.ceil(u*1.1/10)*10
s=n.length
r=s-1
q=s<=6?1:C.d.jU(s/5)
s=B.b([],y.t)
if(x)s.push(H.lK(o,3,o,C.as,0.35,o,F.cJ,o,!0,!1,!1,!1,F.cL,!1,10,F.cS,!0,C.c3,A.aMb(n,new A.ark())))
if(w)s.push(H.lK(o,3,o,I.d0,0.35,D.rq,F.cJ,o,!0,!1,!1,!1,F.cL,!1,10,F.cS,!0,C.c3,A.aMb(n,new A.arl())))
if(v)s.push(H.lK(o,3,o,G.bn,0.35,o,F.cJ,o,!0,!1,!1,!1,F.cL,!1,10,F.cS,!0,C.c3,A.aMb(n,new A.arm())))
s=B.cj(H.aea(H.DY(o,o,o,F.j7,E.ng(o,!1),G.me,G.fP,new E.jG(!0,!0,o,new A.arn(),E.hX(),!1,o,E.re(),E.hX()),s,F.ri,r,t,0,0,G.hb,F.j8,new E.iT(!0,new E.e1(16,o,new E.e8(!0,new A.aro(),36,t/4,!0,!0),!0),G.b6,G.b6,new E.e1(16,o,new E.e8(!0,new A.arp(r,q,n),22,1,!0,!0),!0)))))
p=B.b([],y.h)
if(x)p.push(M.pg)
if(w)p.push(D.H0)
if(v)p.push(D.GO)
return B.aH(B.b([s,C.T,H.a6p(p)],y.p),C.B,C.l,C.o)},
aa2(d,e){return B.eh(new A.aru(this,e))},
Ek(){return B.cD(E.w8(new B.ax(C.d4,B.aH(D.O1,C.q,C.l,C.o),null),C.az),null,260)},
...
return B.Hb(B.jK(C.bS,d,C.an,!1,x,x,x,x,x,x,x,x,x,x,x,x,x,x,new A.arN(w),x,x,x,x,x,x),x,w,e,x,C.fE,x,C.R)},
aa1(d){var x=null,w=A.aMd(d.at),v=A.aMd(d.ax),u=A.aMd(d.ay),t=E.ng(x,!1),s=B.b([H.lK(x,3,x,C.as,0.35,x,F.cJ,x,!0,!1,!1,!1,F.cL,!1,10,F.cS,!0,C.c3,w),H.lK(x,3,x,I.d0,0.35,D.rq,F.cJ,x,!0,!1,!1,!1,F.cL,!1,10,F.cS,!0,C.c3,v)],y.t)
if(!d.as)s.push(H.lK(x,3,x,G.bn,0.35,x,F.cJ,x,!0,!1,!1,!1,F.cL,!1,10,F.cS,!0,C.c3,u))
return H.aea(H.DY(x,x,x,F.j7,t,G.me,G.fP,new E.jG(!0,!0,x,new A.arr(),E.hX(),!1,x,E.re(),E.hX()),s,F.ri,5,100,0,0,G.hb,F.j8,new E.iT(!0,new E.e1(16,x,new E.e8(!0,new A.ars(),34,20,!0,!0),!0),G.b6,G.b6,new E.e1(16,x,new E.e8(!0,new A.art(),22,1,!0,!0),!0))))}}
A.Ld.prototype={
...
x=v.length!==0?w.PA(v,u):null}return B.eh(new A.aDQ(w,u,t,x,r,s))},
...
s=B.x(new B.y(s,new A.az7(v),x),x.h("X.E"))}return B.aA(w,B.aH(s,C.q,C.l,C.o),C.k,w,w,new B.au(C.j,w,t,u,w,w,C.r),w,w,w,w,C.d4,w,w,w)}}
A.l3.prototype={}
A.aFr.prototype={}
var z=a.updateTypes(["m(k0)","fF(m)","aX(m,ea)","aR(m,ea)","kW?(kK,h)","yJ(a7<@,@>)","k0(a7<@,@>)","qr(fL<qr>)","a4<aW<mh>>(hw<aW<mh>>)","m(m,k0)","bS(aL<f,k0>)","bS(aL<f,m>)","ax(l3)"])
A.akN.prototype={
...
A.aN7(u.i(0,"available_source_codes"))
return new A.k0(t,x,w,v)},
$S:z+6}
A.aI0.prototype={
$1(d){return J.T(d)},
$S:81}
...
p=B.b([],y.E)
o=q.a
if(o!=null)p.push(new A.l3("Fuente dominante",A.aMe(o.d)))
p.push(new A.l3("Cobertura",A.aMe(q.b.c)))
p.push(new A.l3("Momentum",A.aMe(A.b6z(q.c.f))))
q=b1==null?a0:b1.f
n=x.e
if(n==null)n=a0
...
i=s.f
h=A.arh(i,"")
i=A.KK(q,"GH",C.as,A.aMf(s,v),h,b2,a3,a4,s.b,A.Hg(s.e),A.arQ(i))
s=A.Hg(n.d)
b2=n.f
h=A.arh(b2,"")
b2=A.KK(m,"SO",I.d0,A.aMf(n,v),h,s,a3,a4,n.b,A.Hg(n.e),A.arQ(b2))
n=A.Hg(a8.d)
s=a8.f
h=A.arh(s,"")
b1.push(B.bU(C.F,B.b([i,b2,A.KK(l,"RD",G.bn,A.aMf(a8,v),h,n,a3,a4,a8.b,A.Hg(a8.e),A.arQ(s))],k),C.N,16,16))
b1.push(D.nF)
...
$S:140}
A.arj.prototype={
$2(d,e){var x=this.a?e.c:0,w=this.b?e.d:0,v=C.c.c6(B.b([x,w,this.c?e.e:0],y.n),new A.ari())
return v>d?v:d},
$S:z+9}
A.ari.prototype={
...
x(A.Fj,B.Ft)
w(B.jy,[A.akN,A.arS,A.arw,A.arj,A.ari,A.aro,A.arp,A.aru,A.ars,A.art,A.arz,A.arA,A.arF,A.arH,A.arI,A.arK,A.arM,A.arR,A.aDQ])
x(A.Px,B.aR)
w(B.u,[A.mh,A.yJ,A.U5,A.k0,A.U6,A.aq1,A.U3,A.U4,A.qr,A.l3,A.aFr])
w(B.fW,[A.aq3,A.aq2,A.aI0,A.aJu,A.aJt,A.ark,A.arl,A.arm,A.arn,A.arq,A.arr,A.arx,A.arO,A.arP,A.ary,A.arG,A.arJ,A.arL,A.arB,A.arC,A.arD,A.arv,A.az7])
x(A.v5,B.wq)
w(B.jx,[A.arg,A.arN,A.arE])
...
return{L:x("cI<aW<iU>>"),r:x("cI<aW<jV>>"),G:x("cI<aW<fp>>"),B:x("cI<aW<hI>>"),Z:x("cI<aW<mh>>"),W:x("cI<aW<fO>>"),e:x("a2"),v:x("dS"),a:x("aW<iU>"),u:x("aW<jV>"),J:x("aW<fp>"),x:x("aW<hI>"),k:x("aW<mh>"),S:x("aW<fO>"),d:x("n5"),D:x("bS"),V:x("n<b4>"),h:x("n<cJ>"),t:x("n<cp>"),s:x("n<k>"),p:x("n<e>"),E:x("n<l3>"),n:x("n<m>"),R:x("bm<kV>"),j:x("M<@>"),f:x("a7<@,@>"),X:x("dP<k,k>"),w:x("y<m,m>"),N:x("k"),U:x("yJ"),m:x("mh"),I:x("qr"),H:x("k0"),A:x("a3<k>"),z:x("@"),g:x("M<@>?"),Y:x("a7<@,@>?"),y:x("m?")}})();(function constants(){var x=a.makeConstList
D.oG=new B.e0(1,-1)
...
D.GO=new E.cJ("Reddit",G.bn,G.b_)
D.H0=new E.cJ("StackOverflow",I.d0,G.b_)
...
x($,"bjH","aZN",()=>B.uk(new A.aJu(),y.I))
x($,"bjG","aZM",()=>B.wQ(new A.aJt(),y.k))})()};
(a=>{a["BdIX6uAmvesIKdYHdwXrlyl//d8="]=a.current})($__dart_deferred_initializers__);